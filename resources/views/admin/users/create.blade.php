...
<div class="page-header">
  ...
  <p class="page-subtitle">Créer un compte manuellement</p>
</div>

<div class="row justify-content-center">
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header"><i class="bi bi-person-plus me-2 text-primary"></i>Informations</div>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="tel" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="+237 6XX XXX XXX">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <select name="role" class="form-select @error('role') is-invalid @enderror" required>
              @foreach(['client','vendeur','livreur','admin'] as $r)
                <option value="{{ $r }}" {{ old('role','client') === $r ? 'selected' : '' }}>{{ ucfirst($r) }}</option>
              @endforeach
            </select>
